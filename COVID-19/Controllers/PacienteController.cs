...
namespace COVID_19.Controllers
{
    ...
    public class PacienteController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<IActionResult> Put(int id, Paciente paciente) { return Ok("Status do paciente atualizado."); }
        [HttpDelete]
        public async Task<IActionResult> Delete(int id) { return Ok("O status do paciente foi deletado."); }
